...
<div class="row">
    ...
    <div class="col-md-4 col-lg-3 mb-2">
        <div class="card">
            <img src="<?php echo e(asset('/storage/' . $product->getImage())); ?>"
            class="card-img-top">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LTW-B_Project-MyPhamStore\MyPhamStore\resources\views/product/index.blade.php ENDPATH**/ ?>