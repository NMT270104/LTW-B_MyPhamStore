            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ms-auto">
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('login')); ?>" class="nav-link active">Login</a>
                        <a href="<?php echo e(route('register')); ?>" class="nav-link active">Register</a>
                        <?php else: ?>
                        <a href="<?php echo e(route('myaccount.orders')); ?>" class="nav-link active">My Orders</a>
...
<?php /**PATH C:\xampp\htdocs\onlineStore\resources\views/layouts/app.blade.php ENDPATH**/ ?>