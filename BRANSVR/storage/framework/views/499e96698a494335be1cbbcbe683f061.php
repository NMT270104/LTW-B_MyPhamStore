...
<div class="container">
    <div class="row ">
        <div class="col-auto py-4"><img src="<?php echo e(asset('img/giammuntichuyengiajpg.jpg')); ?>" alt="">
        </div>
        <div class="col-auto py-4"><img src="<?php echo e(asset('img/bikip3buoc.jpg')); ?>" alt=""></div>
        <div class="col-auto py-4"><img src="<?php echo e(asset('img/trungthudoanvien.jpg')); ?>" alt=""></div>
    </div>
</div>
