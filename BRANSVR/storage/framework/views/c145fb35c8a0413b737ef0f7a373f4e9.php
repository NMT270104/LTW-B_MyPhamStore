            ...
            <div class="login-box">
                <form method="POST" action="<?php echo e(route('register')); ?>">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" id="name" type="text" class="<?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="registerAndlogin-link">
                            <p>I have acc account. <a href="<?php echo e(route('login')); ?>">Login</a></p>
                        </div>        
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LTW-B_Project-MyPhamStore\MyPhamStore\resources\views/auth/register.blade.php ENDPATH**/ ?>