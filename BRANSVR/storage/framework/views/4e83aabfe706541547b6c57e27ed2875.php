								...
								<li>
									<div class="header-icons">
                                        <ul>
                                            ...
                                            <li><form id="logout" action="<?php echo e(route('logout')); ?>" method="POST">
                                            <a role="button"
...
<?php /**PATH C:\xampp\htdocs\LTW-B_Project-MyPhamStore\MyPhamStore\resources\views/Layouts/app.blade.php ENDPATH**/ ?>