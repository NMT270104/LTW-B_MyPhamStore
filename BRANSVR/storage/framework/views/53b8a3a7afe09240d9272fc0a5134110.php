    ...
    <div class="sidebar pe-4 pb-3 bg-light">
        <nav class="navbar navbar-dark">
            ...
            <div class="navbar-nav w-100">
                <a href="<?php echo e(route('admin.home.index')); ?>" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                <div class="nav-item dropdown">
                    <a href="<?php echo e(route('admin.home.index')); ?>" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Elements</a>
