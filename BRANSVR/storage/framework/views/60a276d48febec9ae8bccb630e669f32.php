            ...
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <form method="POST" action="<?php echo e(route('admin.product.store')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="name" value="<?php echo e(old('type')); ?>" type="text" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" style="color: #F28123">Tradesmark Product:</label>
                        <input name="name" value="<?php echo e(old('tradesmark')); ?>" type="text" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" style="color: #F28123">Mass Product:</label>
                        <input name="name" value="<?php echo e(old('mass')); ?>" type="text" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" style="color: #F28123">Volume Product:</label>
                        <input name="name" value="<?php echo e(old('volume')); ?>" type="text" class="form-control">
                    </div>
