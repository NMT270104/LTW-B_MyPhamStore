    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('admin.product.update',['id' => $viewData['products']->getId()]) }}"
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="mb-3 row">
                        ...
                        <div class="col-lg-10 col-md-6 col-sm-12">
                        <input name="price" value="{{ $viewData['products']->getPrice() }}" type="number"
                            class="form-control">
                        </div>
                    </div>
                </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="description" rows="3">{{ $viewData['products']->getDescription() }}</textarea>
            </div> 
